...
class Display{
    ...
    constructor(dispValAnt,dispValAct,DM){
        this.DM = DM;
    ...
    operar(operacion){
        ...
        this.valAnt = numero ? this.valAnt : this.valAct;
        this.valAct = '';
        this.imprimeValores();
    }
...
const DM = document.getElementById('display');


const disp = new Display(dispValAnt,dispValAct,DM);
